            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        <p>Numero Facture : <strong>{{ $invoice->getSerialNumber() }}</strong></p>
                        <p>Date edition : <strong>{{ $invoice->getDate() }}</strong></p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table ">
            <thead>
                <tr class="text-center">
                    <th scope="col" class="border-0 pl-0">Libelé</th>
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">{{ __('invoices::invoice.units') }}</th>
                    @endif
                    <th scope="col" class="text-center border-0">Quantiter</th>
                    ...
                    @endif
                    <th scope="col" class="text-right border-0 pr-0">Prix Total</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
                ...
                @if($invoice->hasItemOrInvoiceDiscount())
                    <tr>
                        ...
                        <td class="text-right pl-0">Montant Total</td>
                        <td class="text-right pr-0">
                           Ar {{ $invoice->total_discount }}
                        </td>
                    </tr>
                @endif
